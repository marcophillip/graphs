...
class LSTMClassifier(nn.Module):
    def __init__(self, load_embeddings: bool = False):
    ...
    def forward(self, x):
        ...
        # embedding = embedding.transpose(1, 0) #  change from B, L Hin to L, B, Hin
...
if __name__ == "__main__":
    ...
    model = LSTMClassifier(load_embeddings=args.load_embeddings) 
